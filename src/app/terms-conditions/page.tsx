  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="prose dark:prose-invert text-foreground">
        ...
        <p>
          Welcome to BarberStyle Essentials. By accessing or using our website,
        ...
        <p>
          ...
          on this site are accurate, complete, reliable, current, or error-free.
        </p>
        <h2>Ordering and Payment</h2>
        <p>
          When you place an order, you are offering to purchase a product. We
          reserve the right to accept or decline your offer for any reason.
          Payment must be received in full before the dispatch of your order.
        </p>
        <h2>Shipping and Delivery</h2>
        <p>
          Shipping costs and delivery times may vary depending on the delivery
          address and the products ordered. We are not responsible for delays
          outside our control.
        </p>
        ...
        <p>
          ...
          images, is the property of BarberStyle Essentials and is protected by
          copyright laws.
        </p>
        <h2>Limitation of Liability</h2>
        <p>
          BarberStyle Essentials shall not be liable for any indirect,
          incidental, special, consequential or punitive damages resulting from
          your use of this website or our products.
        </p>
        ...
        <p>
          ...
          contact us at legal@barberstyleessentials.com.
        </p>
      </div>
    </div>
  );
